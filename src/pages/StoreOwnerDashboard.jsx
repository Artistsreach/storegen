...
// import ShopifyConnectForm from '@/components/ShopifyConnectForm'; // Replaced by ShopifyImportWizard
import ShopifyImportWizard from '@/components/ShopifyImportWizard'; // Import the new wizard
...
const StoreOwnerDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Render the new ShopifyImportWizard */}
      <ShopifyImportWizard 
        isOpen={isShopifyDialogOpen} 
        onClose={() => {
          setIsShopifyDialogOpen(false);
          // Optionally reset tab if needed, or let user stay on Shopify tab
          // if (activeTab === 'shopify-import') setActiveTab('ai-prompt'); 
        }} 
      />
    </div>
  );
